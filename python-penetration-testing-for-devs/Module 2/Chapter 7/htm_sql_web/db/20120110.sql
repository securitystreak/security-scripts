...
--
-- Host: localhost
-- Generation Time: Jan 10, 2012 at 03:19 PM
...
CREATE TABLE IF NOT EXISTS `products` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Product Details' AUTO_INCREMENT=8 ;
...
(4, 1, 'iPhone 3Gs', 'iPhone-3GS.jpg', 400, 'testing'),
(5, 2, 'Nokia N8', 'Nokia_N8.jpg', 300, 'good mobile'),
(6, 3, 'Wave 8500', 'Samsung-Wave.jpg', 600, 'Fabulous Mobile'),
(7, 0, 'Galaxy Tab', 'Samsung-Galaxy-S.jpg', 800, 'testing');
